...
export const routing: ModuleWithProviders = RouterModule.forRoot([
  ...
  {path: 'settings',      loadChildren: () => import('./settings/settings.module').then(m => m.SettingsModule), canActivate: [CanActivateGuard]},
  {path: 'tags',          loadChildren: () => import('./tags/tags.module').then(m => m.TagsModule), canActivate: [CanActivateGuard]},
  {path: 'applications',  loadChildren: () => import('./applications/applications.module').then(m => m.ApplicationsModule), canActivate: [CanActivateGuard]},
  {path: 'datasinks',     loadChildren: () => import('./datasinks/datasinks.module').then(m => m.DatasinksModule), canActivate: [CanActivateGuard]},
  {path: 'control',       loadChildren: () => import('./control/control.module').then(m => m.ControlModule), canActivate: [CanActivateGuard]},
  {path: 'about',         loadChildren: () => import('./about/about.module').then(m => m.AboutModule), canActivate: [CanActivateGuard]},
