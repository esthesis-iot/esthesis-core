...
export class InfrastructureZookeeperComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  fetchData(page: number, size: number, sort: string, sortDirection: string) {
    this.zookeeperServerService.getAll(this.qForms.appendPagingToFilter(null, page, size, sort, sortDirection))
    .subscribe(onNext => {
