...
env \
    ...
    ESTHESIS_DFL_DB_JDBC_URL="jdbc:mysql://mysql.esthesis.localdev:3306/esthesiscore?useSSL=false&useUnicode=true&characterEncoding=UTF-8&connectionTimeZone=Etc/UTC" \
