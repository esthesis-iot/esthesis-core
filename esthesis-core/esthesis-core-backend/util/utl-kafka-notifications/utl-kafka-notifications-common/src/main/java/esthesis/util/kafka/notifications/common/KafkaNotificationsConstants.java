...
public class KafkaNotificationsConstants {
  ...
  Kafka topics. The actual Kafka topic those two channels point to is defined in the application.properties
  file. We prefer to keep this configuration in the application settings instead, however
