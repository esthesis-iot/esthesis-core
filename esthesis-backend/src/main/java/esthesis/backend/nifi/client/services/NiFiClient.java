package esthesis.backend.nifi.client.services;

import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.Type.DISTRIBUTE_LOAD;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.CLIENT_ID;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.CONTROLLER_SERVICES;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.FLOW;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.PROCESSORS;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.PROCESS_GROUPS;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.RUN_STATUS;
import static esthesis.backend.nifi.client.util.NiFiConstants.Processor.UrlPaths.VERSION;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.COMMAND_REQUEST_INSERT_QUERY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.CONFLICT_RESOLUTION_STRATEGY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DB_CONNECTION_URL;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DB_DRIVER_CLASS_NAME;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DB_DRIVER_LOCATION;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DB_USER;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DCBP_SERVICE;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DEVICE_ID_QUERY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.DIRECTORY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.ESTHESIS_HARDWARE_ID;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.HOSTNAME;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_CHARSET;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_CONSISTENCY_LEVEL;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_DB_NAME;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_MAX_CONNECTION_TIMEOUT;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_MAX_RECORDS_SIZE;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_PASSWORD;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_QUERY_CHUNK_SIZE;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_QUERY_RESULT_TIME_UNIT;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_RETENTION_POLICY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_URL;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.INFLUX_USERNAME;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.JDBC_CONNECTION_POOL;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.MESSAGE_BODY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.MESSAGE_PRIORITY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.OBTAIN_GENERATED_KEYS;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PORT;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PROTOCOL;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PSWD;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PUT_DB_RECORD_DCBP_SERVICE;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PUT_DB_RECORD_FIELD_CONTAINING_SQL;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PUT_DB_RECORD_READER;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PUT_DB_RECORD_STATEMENT_TYPE;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PUT_DB_RECORD_TABLE_NAME;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.PUT_SQL_STATEMENT;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.SQL_SELECT_QUERY;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.SSL_CONTEXT_SERVICE;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.CONNECTABLE_COMPONENT_TYPE.INPUT_PORT;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.CONNECTABLE_COMPONENT_TYPE.OUTPUT_PORT;
import static esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.CONNECTABLE_COMPONENT_TYPE.PROCESSOR;
import static esthesis.backend.nifi.client.util.NiFiConstants.SyncErrors.NON_EXISTENT_PROCESSOR;
...
import esthesis.backend.nifi.client.util.JacksonIgnoreInvalidFormatHandler;
import esthesis.backend.service.NiFiService;
import esthesis.backend.nifi.client.dto.CallReplyDTO;
import esthesis.backend.nifi.client.dto.NiFiSearchAlgorithm;
import esthesis.backend.nifi.client.util.NiFiConstants;
import esthesis.backend.nifi.client.util.NiFiConstants.Bundle.BundleArtifact;
import esthesis.backend.nifi.client.util.NiFiConstants.Bundle.BundleGroup;
import esthesis.backend.nifi.client.util.NiFiConstants.ControllerService.Type;
import esthesis.backend.nifi.client.util.NiFiConstants.Processor;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.CONSISTENCY_LEVEL;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.DATA_UNIT;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.FAILED_RELATIONSHIP_TYPES;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.KEY_TRUST_STORE_TYPE;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.STATE;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.STATEMENT_TYPE;
import esthesis.backend.nifi.client.util.NiFiConstants.Properties.Values.SUCCESSFUL_RELATIONSHIP_TYPES;
import esthesis.backend.nifi.client.util.Util;
