...
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.OPERATION_COUNT;
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.OPERATION_MAX;
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.OPERATION_MEAN;
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.OPERATION_MIN;
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.OPERATION_QUERY;
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.OPERATION_SUM;
import static esthesis.backend.config.AppConstants.DigitalTwins.DTOperations.SUPPORTED_OPERATIONS;
...
import esthesis.backend.config.AppConstants.DigitalTwins.Type;
