...
import esthesis.platform.server.config.AppConstants.Campaign.Condition;
...
import esthesis.platform.server.config.AppConstants.Campaign.Type;
...
import esthesis.platform.server.dto.CampaignValidationErrorDTO;
import esthesis.platform.server.model.Campaign;
import esthesis.platform.server.service.CampaignService;
import esthesis.platform.server.service.WorkflowService;
