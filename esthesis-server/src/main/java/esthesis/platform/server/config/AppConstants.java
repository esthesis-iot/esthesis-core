...
public class AppConstants {
  ...
  public static class Dashboard {
    public static class WidgetType {
      // Keep these inline with the beans under esthesis.platform.server.service.widgets.
      public static final String SENSOR_VALUE = "sensorValue";
    }
  }

  public static class NiFi {
    public static final String SINKS_PACKAGE = "esthesis.platform.server.nifi.sinks.";
