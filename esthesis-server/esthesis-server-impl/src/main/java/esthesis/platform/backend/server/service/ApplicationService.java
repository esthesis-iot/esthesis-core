...
import static esthesis.platform.backend.server.config.AppConstants.Audit.Level.CREATE;
import static esthesis.platform.backend.server.config.AppConstants.Audit.Level.UPDATE;
...
import esthesis.platform.backend.server.config.AppConstants.Audit.Event;
import esthesis.platform.backend.server.config.AppConstants.User.Status;
import esthesis.platform.backend.server.dto.ApplicationDTO;
import esthesis.platform.backend.server.mapper.ApplicationMapper;
import esthesis.platform.backend.server.model.Application;
import esthesis.platform.backend.server.repository.ApplicationRepository;
