...
import esthesis.platform.backend.server.nifi.client.dto.EsthesisTemplateVersionDTO;
import esthesis.platform.backend.server.nifi.client.dto.NiFiAboutDTO;
