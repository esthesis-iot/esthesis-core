...
import esthesis.platform.backend.server.config.AppConstants.NiFi;
import esthesis.platform.backend.server.config.NiFiSinkConfiguration;
import esthesis.platform.backend.server.dto.NiFiDTO;
import esthesis.platform.backend.server.dto.nifisinks.NiFiLoggerFactoryDTO;
import esthesis.platform.backend.server.dto.nifisinks.NiFiProducerFactoryDTO;
import esthesis.platform.backend.server.dto.nifisinks.NiFiReaderFactoryDTO;
import esthesis.platform.backend.server.dto.nifisinks.NiFiSinkDTO;
import esthesis.platform.backend.server.dto.nifisinks.NiFiWriterFactoryDTO;
import esthesis.platform.backend.server.model.NiFiSink;
import esthesis.platform.backend.server.model.QNiFiSink;
...
import esthesis.platform.backend.server.repository.NiFiSinkRepository;
...
public class NiFiSinkService extends BaseService<NiFiSinkDTO, NiFiSink> {
  ...
  private String[] createPath(NiFiSinkDTO niFiSinkDTO, NiFiSinkFactory niFiSinkFactory) {
    ...
    String factoryTypePath = niFiSinkFactory.getClass().getName().replace(NiFi.SINKS_PACKAGE, "");
