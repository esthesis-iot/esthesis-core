...
public class KeyService {
   ...
   * @throws SignatureException       thrown when something unexpected occurs
   *                                  during signing
   */
   ...
   * @throws InvalidKeySpecException   thrown when the provided key is invalid
   * @throws InvalidKeyException       thrown when the provided key is invalid
   * @throws BadPaddingException       thrown when the provided cipherFactory is
   *                                   not valid
   * @throws IllegalBlockSizeException thrown when the provided cipherFactory is
   *                                   not valid
   */
  ...
  throws NoSuchPaddingException, NoSuchAlgorithmException,
    ...
    cipher
        .init(Cipher.DECRYPT_MODE,
            pemToPrivateKey(privateKeyPEM, keyAlgorithm));
