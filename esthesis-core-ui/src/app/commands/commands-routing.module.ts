...
import {commandNameResolver} from "../shared/components/breadcrumb/breadcrumb.resolver";
...
const routes: Routes = [
  ...
  {
    path: "reply/:id", component: CommandReplyComponent, resolve: {breadcrumb: commandNameResolver}
  },
];
