...
@Component({
  selector: "app-dashboard-item-devices-last-seen-edit",
  templateUrl: "./dashboard-item-devices-last-seen-edit.component.html"
})
export class DashboardItemDevicesLastSeenEditComponent extends SecurityBaseComponent implements OnInit {
  form!: FormGroup;

  constructor(@Inject(MAT_DIALOG_DATA) public readonly incomingDi: DashboardItemDto,
    readonly fb: FormBuilder, public dialogRef: MatDialogRef<DashboardItemDevicesLastSeenEditComponent>) {
